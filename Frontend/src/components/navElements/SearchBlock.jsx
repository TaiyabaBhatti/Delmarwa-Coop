...
const SearchBlock = () => {
  ...
  return (
    <form
      ...
      className="transition-all duration-300  max-[1129px]:row-start-2 max-[1129px]:col-span-2 bg-gray-100 p-3.5 border-t-2 border-t-athens-gray sm:p-0 sm:bg-transparent sm:border-none"
    >
