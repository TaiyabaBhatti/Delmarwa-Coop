...
const FilterPanel = ({ filters, setFilters }) => {
  return (
    <aside className="sticky top-0 z-50 self-start w-full h-fit md:h-screen md:min-w-52 md:w-72 border-r-2 border-r-gray-200 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scroll-smooth ">
      {/* logo */}
